...
export function CareersPage() {
  ...
  const matches = useMemo(() => active === 'all' ? careerResults?.matches ?? [] : careerResults?.categories[active] ?? [], [active, careerResults]);
